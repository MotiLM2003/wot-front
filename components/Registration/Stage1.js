			...
			<div className='flex flex-col gap-2'>
				...
				<div>
					<Input
						...
						placeholder='E-Mail'
						onChange={onChange}
						className={errors?.email ? `border-2 border-red` : ''}
					/>
					<div className='flex gap-3 mt-4 '>
						<div>
							<Input
								...
								onChange={onChange}
								className={errors?.password ? `border-2 border-red` : ''}
							/>
						</div>{' '}
						<div>
							<Input
				...
				<div className='flex gap-3 '>
					<div>
						<Input
							...
							onChange={onChange}
							className={errors?.firstName ? `border-2 border-red` : ''}
						/>
					</div>{' '}
					<div>
						<Input
							...
							onChange={onChange}
							className={errors?.lastName ? `border-2 border-red` : ''}
						/>
					</div>
				</div>
				{/*  */}
				<div className='flex gap-3 '>
					<div>
						<Input
							...
							onChange={onChange}
							className={errors?.phone ? `border-2 border-red` : ''}
						/>
					</div>{' '}
					<div>
						<Input
				...
				<div className='flex gap-3 '>
					...
					<div>
						<Input
							...
							name='idNumber'
							value={data.idNumber}
							className={errors?.idNumber ? `border-2 border-red` : ''}
						/>
					</div>
				</div>
			</div>
			...
			<div className='mt-4 flex flex-col gap-3'>
				...
				<div className='flex gap-3  justify-between'>
					<Input
						...
						type='text'
						placeholder='Country'
						className={errors?.country ? `border-2 border-red` : ''}
					/>
					<Input
						icon={city}
						type='text'
						...
						className={errors?.city ? `border-2 border-red` : ''}
					/>
				</div>
				<div className='flex gap-3  justify-between'>
					<Input
						...
						value={data.street}
						placeholder='Street'
						className={errors?.street ? `border-2 border-red` : ''}
					/>
					<Input
						icon={location}
						type='text'
						...
						className={errors?.zipCode ? `border-2 border-red` : ''}
					/>
				</div>
			</div>
